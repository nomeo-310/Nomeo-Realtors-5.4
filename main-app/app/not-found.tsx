    ...
    <div className='flex items-center justify-center w-full min-h-screen font-urbanist dark:bg-[#424242]'>
      <div className="flex md:gap-6 items-center flex-col md:flex-row p-8 gap-14">
        ...
        <div className='text-secondary-blue'>
          ...
          <p className='text-dark-grey text-xl leading-7 mt-5 text-center md:text-left'>The page you are looking for does not exist. Head back to the <Link href="/" className='text-primary-red underline text-xl font-semibold'>home page</Link></p>
        </div>
      </div>
    </div>
  );

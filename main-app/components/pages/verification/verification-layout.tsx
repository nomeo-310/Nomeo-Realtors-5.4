    ...
    <div className='w-full h-full flex flex-col gap-6 md:gap-8 lg:gap-10 pb-6'>
      ...
      <div className="flex flex-col gap-4">
        <div className="h-10 w-full flex">
          <TabButton label='Agents' counts={totalCounts?.unverifiedAgents} tab='/admin-dashboard/verifications'/>
          <TabButton label='Rentals' tab='/admin-dashboard/verifications/rentals' counts={totalCounts?.pendingRentals}/>
          <TabButton label='Apartments' counts={totalCounts?.pendingProperties} tab='/admin-dashboard/verifications/apartments'/>

...
const AdminTransactionLayout = ({children}:{children: React.ReactNode}) => {
    ...
    <div className='w-full h-full flex flex-col gap-6 md:gap-8 lg:gap-10 pb-6'>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="h-10 w-full flex">
          <TabButton tab='/admin-dashboard/transactions' label='Agents' counts={0}/>
          <TabButton tab='/admin-dashboard/transactions/rentals' label='Rentals' counts={3}/>
          <TabButton tab='/admin-dashboard/transactions/apartments' label='Apartments' counts={3}/>

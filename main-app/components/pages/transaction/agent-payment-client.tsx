      ...
      return (
        <TableHeader className="rounded-lg h-12 [&_tr]:border-b">
          <TableRow className="bg-white hover:bg-white border-b-0 dark:bg-[#424242]">
            ...
            <TableHead className="text-center font-semibold uppercase">Agent ID</TableHead>
    ...
    const PaymentItem = () => {
      return (
        <TableRow>
          ...
          <TableCell className="text-xs md:text-sm text-center">T234567123456</TableCell>
          <TableCell className="text-xs md:text-sm text-center capitalize">Rental</TableCell>
...
export default AgentPaymentClient
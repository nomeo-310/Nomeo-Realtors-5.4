    ...
    <div className='w-full h-full flex flex-col gap-6 md:gap-8 lg:gap-10 pb-6'>
      ...
      <div className="flex flex-col gap-4">
        <div className="h-10 w-full flex">
          <TabButton label='All Blogs' counts={totalCounts?.published} tab='/admin-dashboard/created-blogs'/>
          <TabButton label='Drafts' tab='/admin-dashboard/blogs/drafts' counts={totalCounts?.draft}/>
          <TabButton label='Deleted' counts={totalCounts?.deleted} tab='/admin-dashboard/created-blogs/deleted'/>
          <TabButton label='Collaboration' counts={totalCounts?.collaboration} tab='/admin-dashboard/created-blogs/collaboration' className='hidden md:flex'/>

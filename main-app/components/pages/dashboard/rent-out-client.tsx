...
const RentOutClient = () => {
  ...
  const RentOutList = () => {
    ...
    const MobileRentalListItem = ({open, toggleTable }:mobileItemProps) => {
      return (
  ...
  return (
    <div className='w-full h-full flex flex-col gap-6 md:gap-8 lg:gap-10 pb-6'>
      <div className="items-center flex justify-between w-full">
        <h2 className='text-xl font-semibold font-quicksand md:text-2xl lg:text-3xl'>Rent Outs</h2>
      </div>
      <div className="flex flex-col gap-4">
        <div className="w-full md:w-[60%] xl:w-[40%] flex gap-1 mb-6">
          <InputWithIcon 
            ...
            inputClassName='placeholder:text-black/70 border dark:border-white/70 rounded-lg rounded-r-none'
          />

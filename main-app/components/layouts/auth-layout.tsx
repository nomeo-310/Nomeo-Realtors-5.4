...
const AuthLayout = ({children}:{children:React.ReactNode}) => {
  ...
  return (
    <React.Fragment>
      <Link href={'/'} className="pl-0 xl:pl-0 absolute md:top-10 top-8 lg:top-12 md:left-10 left-3 lg:left-20 z-[4000] flex items-center text-white gap-2 lg:gap-3 py-2 px-3 xl:px-4 rounded-full">
